...
<head>
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="{{asset('Dashboard-Data/assets/img/logo.png')}}">
  <link rel="icon" type="image/png" href="{{asset('Dashboard-Data/assets/img/logo.png')}}">
  <title>
    Aplikasi Monitoring Kolam
  </title>
...
<body class="g-sidenav-show   bg-gray-100">
  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="user-panel mt-3 pb-3 mb-3 d-flex justify-content-center" href=" https://demos.creative-tim.com/argon-dashboard/pages/dashboard.html " target="_blank">
        <img src="{{asset('Dashboard-Data/assets/img/logo.png')}}" class="img-fluid" alt="logo" style="width: 100px; height: auto;">
      ...
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link active" href="./pages/dashboard.html">
            ...
            <span class="nav-link-text ms-1">Data Real Time</span>
          </a>
        </li>
        <li class="nav-item">
  ...
  <main class="main-content position-relative border-radius-lg ">
    ...
    <div class="container-fluid py-4">
      <div class="row">
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4" style="margin-right: 8%;">
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Tempereature</p>
                ...
                <div class="col-4 text-end">
                  <div class="icon icon-shape bg-gradient-primary shadow-primary text-center rounded-circle">
                    <i class="text-lg opacity-10" aria-hidden="true"> <span class="material-symbols-outlined">
                      device_thermostat
                      </span></i>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Turbidity</p>
                    <h5 class="font-weight-bolder">
                      ----NTU
                    </h5>
                  </div>
        ...
        <div class="col-lg-12 mb-lg-0 mb-4">
          <div class="card z-index-2 h-100">
            <div class="card-header pb-0 pt-3 bg-transparent">
              <h6 class="text-capitalize">Chart Temperature</h6>
              <p class="text-sm mb-0">
                <i class="fa fa-arrow-up text-success"></i>
                <span class="font-weight-bold">--.--°C more</span> in today
              </p>
            </div>
            <div class="card-body p-3">
              <div class="chart">
          ...
          <div class="card ">
            <div class="card-header pb-0 p-3">
              <div class="d-flex justify-content-between">
                <h6 class="mb-2">5th last date</h6>
              </div>
            </div>
